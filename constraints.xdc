set_property PACKAGE_PIN AN16 [get_ports "DIP[0]"]
set_property IOSTANDARD LVCMOS12 [get_ports "DIP[0]"]
set_property PACKAGE_PIN AN19 [get_ports "DIP[1]"]
set_property IOSTANDARD LVCMOS12 [get_ports "DIP[1]"]
set_property PACKAGE_PIN AP18 [get_ports "DIP[2]"]
set_property IOSTANDARD LVCMOS12 [get_ports "DIP[2]"]
set_property PACKAGE_PIN AN14 [get_ports "DIP[3]"]
set_property IOSTANDARD LVCMOS12 [get_ports "DIP[3]"]
